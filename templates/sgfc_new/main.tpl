    ...
    <div id="content" class="container">
        <div  class="row">
            ...
            <div class="col-lg-8 col-center">
                ...
                {*{custom id="3-6"  template="custom"}*}
                {*{include file="engine/modules/blockpro/block.pro.3.php?day=1&sort=date"}*}
                {*{content}*}


                {*{include file="engine/modules/blockpro/block.pro.3.php?dayCount=1&sort=date"}*}
                {*{include file="engine/modules/blockpro/block.pro.3.php?limit=3&dayCount=1&sort=date"}*}
                {*{include file="engine/modules/blockpro/block.pro.3.php?limit=3&sort=date"}*}
                {*{include file="engine/modules/blockpro/block.pro.3.php?limit=3"}*}
                {*{include file="engine/modules/blockpro/block.pro.3.php?limit=3&day=1&dayCount=1&sort=date"}*}

            </div>
            <div class="col-lg-2 col-reight">
                Reight
            </div>
        </div>
    </div>
